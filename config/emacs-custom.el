(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-ref ensime flycheck-haskell haskell-mode all-the-icons neotree powerline company-irony-c-headers irony-eldoc flycheck-irony magit company-irony company irony nlinum zenburn-theme))))
(custom-set-faces
